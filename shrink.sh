  ...
  if [[ -f $file ]]; then
    ...
    if [[ ! -f "$output_file" ]]; then
      ...
      ffmpeg \
        ...
        -i watermark.png \
        -filter_complex "\
          [0:v]crop=554:106:62:926,avgblur=15[fg];\
          [0:v][fg]overlay=62:926[blurredTimestamp];\
          [blurredTimestamp]scale=640:360,colorchannelmixer=.3:.4:.3:0:.3:.4:.3:0:.3:.4:.3[blurredTimestamp];\
